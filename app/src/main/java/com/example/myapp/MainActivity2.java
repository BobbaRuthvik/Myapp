...
public class MainActivity2 extends AppCompatActivity {
    ...
    private ArrayList<com.example.myapp.Messages> messagesList;
    private com.example.myapp.RecyclerAdapter recyclerAdapter;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    com.example.myapp.Messages messages = new com.example.myapp.Messages();
                ...
                recyclerAdapter = new com.example.myapp.RecyclerAdapter(getApplicationContext(), messagesList);
